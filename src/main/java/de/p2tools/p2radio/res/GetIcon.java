...
package de.p2tools.p2radio.res;
...
public class GetIcon {
    ...
    private final static String PATH_PROGRAM = "/de/p2tools/p2radio/res/program/";
    private final static String PATH_SENDER = "/de/p2tools/p2radio/res/sender/";
    private final static String PATH_RES = "/de/p2tools/p2radio/res/";
