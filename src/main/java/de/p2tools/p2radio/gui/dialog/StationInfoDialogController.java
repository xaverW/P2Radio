        ...
        for (int i = 0; i < PlayableXml.MAX_ELEM; ++i) {
            if (station == null) {
                ...
                switch (i) {
                    ...
                    case PlayableXml.STATION_PROP_INT_BITRATE_INT:
                    ...
                    case PlayableXml.STATION_PROP_DATE_INT:
                        ...
                        break;
                    case PlayableXml.STATION_PROP_DATE_LONG_INT:
                        lblCont[i].setText(station.getStationDate().toString());
                        break;
                    ...
                    case PlayableXml.STATION_PROP_URL_INT:
                        ...
                        break;
                    case PlayableXml.STATION_PROP_DOUBLE_URL_INT:
