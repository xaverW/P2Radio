...
public class ProgIcons {
    ...
    public static P2Image ICON_DIALOG_ON = new P2Image(ICON_PATH_LONG, "boolean-is-on.png", 16, 16);
    ...
    public static P2Image IMAGE_TABLE_STATION_SAVE = new P2Image(ICON_PATH_LONG, "table-save.png", 14, 14);
    public static P2Image IMAGE_TABLE_DEL = new P2Image(ICON_PATH_LONG, "table-del.png", 14, 14);

    public static P2Image IMAGE_TABLE_GRADE = new P2Image(ICON_PATH_LONG, "table-grade.png", 18, 18);
    ...
    public static P2Image ICON_TOOLBAR_FAVOURITE_NEW = new P2Image(ICON_PATH_LONG, "toolbar-new.png", 26, 26);
    public static P2Image ICON_TOOLBAR_STATION_START = new P2Image(ICON_PATH_LONG, "toolbar-start.png", 26, 26);
    public static P2Image ICON_TOOLBAR_STATION_STOP = new P2Image(ICON_PATH_LONG, "toolbar-stop.png", 26, 26);
