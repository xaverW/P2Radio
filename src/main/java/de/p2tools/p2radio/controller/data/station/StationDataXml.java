...
public class StationDataXml {
    ...
    public static final int STATION_PROP_IS_HISTORY_INT = 24;
    public static final String STATION_PROP_IS_History = "History";

    public static final int STATION_PROP_BLACK_BLOCKED_URL_INT = 25;
    public static final String STATION_PROP_BLACK_BLOCKED_URL = "BlackBlocked";

    public static final int STATION_PROP_URL_RESOLVED_INT = 26;
    public static final String STATION_PROP_URL_RESOLVED = "URL-resolved";

    public static final int STATION_PROP_WEBSITE_INT = 27;
    public static final String STATION_PROP_WEBSITE = "Website";

    public static final int STATION_PROP_BUTTON1_INT = 28;
    public static final String STATION_PROP_BUTTON1 = "";
    public static final int STATION_PROP_BUTTON2_INT = 29;
    ...
    public static String[] COLUMN_NAMES = {
            ...
            STATION_PROP_DESCRIPTION, STATION_PROP_DATE, STATION_PROP_DATE_LONG, STATION_PROP_DATE_LAST_START,
