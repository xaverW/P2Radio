...
public class PlayableXml {
    ...
    public static final int STATION_PROP_GRADE_INT = 4;
    public static final String STATION_PROP_GRADE = "Bewertung";

    public static final int STATION_PROP_CLICK_COUNT_INT = 5;
    public static final String STATION_PROP_CLICK_COUNT = "Starts";

    public static final int STATION_PROP_CLICK_TREND_INT = 6;
    public static final String STATION_PROP_CLICK_TREND = "Trend";


    public static final int STATION_PROP_GENRE_INT = 7;
    public static final String STATION_PROP_GENRE = "Genre";

    public static final int STATION_PROP_CODEC_INT = 8;
    public static final String STATION_PROP_CODEC = "Codec";

    public static final int STATION_PROP_BITRATE_INT = 9;
    public static final String STATION_PROP_BITRATE = "Bitrate";

    public static final int STATION_PROP_OWN_INT = 10;
    public static final String STATION_PROP_OWN = "Eigener";


    public static final int STATION_PROP_COUNTRY_INT = 11;
    public static final String STATION_PROP_COUNTRY = "Land";

    public static final int STATION_PROP_STATE_INT = 12;
    public static final String STATION_PROP_STATE = "Region";

    public static final int STATION_PROP_COUNTRY_CODE_INT = 13;
    public static final String STATION_PROP_COUNTRY_CODE = "Länderkürzel";

    public static final int STATION_PROP_LANGUAGE_INT = 14;
    public static final String STATION_PROP_LANGUAGE = "Sprache";

    public static final int STATION_PROP_VOTES_INT = 15;
    public static final String STATION_PROP_VOTES = "Bewertung";

    public static final int STATION_PROP_DESCRIPTION_INT = 16;
    public static final String STATION_PROP_DESCRIPTION = "Beschreibung";

    public static final int STATION_PROP_DATE_INT = 17;
    public static final String STATION_PROP_DATE = "Datum";

    public static final int STATION_PROP_DATE_LONG_INT = 18;
    public static final String STATION_PROP_DATE_LONG = "DatumL";

    public static final int STATION_PROP_URL_INT = 19;
    public static final String STATION_PROP_URL = "URL";

    public static final int STATION_PROP_WEBSITE_INT = 20;
    public static final String STATION_PROP_WEBSITE = "Website";

    public static final int STATION_PROP_BUTTON1_INT = 21;
    public static final String STATION_PROP_BUTTON1 = "";
    public static final int STATION_PROP_BUTTON2_INT = 22;
    public static final String STATION_PROP_BUTTON2 = "";

    public static String[] COLUMN_NAMES = {
            STATION_PROP_NO, STATION_PROP_STATION_NO, STATION_PROP_STATION_NAME, STATION_PROP_COLLECTION, STATION_PROP_GRADE,
            ...
            STATION_PROP_DESCRIPTION, STATION_PROP_DATE, STATION_PROP_DATE_LONG, STATION_PROP_URL, STATION_PROP_WEBSITE,
            STATION_PROP_BUTTON1, STATION_PROP_BUTTON2
    };
    public static int MAX_ELEM = 23;
}
