...
public class PlayableXml {
    ...
    public static final int STATION_PROP_INT_BITRATE_INT = 11;
    public static final String STATION_PROP_INT_BITRATE = "BitrateInt";

    public static final int STATION_PROP_OWN_INT = 12;
    public static final String STATION_PROP_OWN = "Eigener";


    public static final int STATION_PROP_COUNTRY_INT = 13;
    public static final String STATION_PROP_COUNTRY = "Land";

    public static final int STATION_PROP_STATE_INT = 14;
    public static final String STATION_PROP_STATE = "Region";

    public static final int STATION_PROP_COUNTRY_CODE_INT = 15;
    public static final String STATION_PROP_COUNTRY_CODE = "Länderkürzel";

    public static final int STATION_PROP_LANGUAGE_INT = 16;
    ...
    public static final int STATION_PROP_DATE_INT = 19;
    public static final String STATION_PROP_DATE = "Datum";

    public static final int STATION_PROP_DATE_LONG_INT = 20;
    ...
    public static final int STATION_PROP_URL_RESOLVED_INT = 23;
    public static final String STATION_PROP_URL_RESOLVED = "URL-resolved";

    public static final int STATION_PROP_WEBSITE_INT = 24;
    public static final String STATION_PROP_WEBSITE = "Website";

    public static final int STATION_PROP_BUTTON1_INT = 25;
    public static final String STATION_PROP_BUTTON1 = "";
    public static final int STATION_PROP_BUTTON2_INT = 26;
    ...
    public static String[] COLUMN_NAMES = {
            ...
            STATION_PROP_URL, STATION_PROP_DOUBLE_URL, STATION_PROP_URL_RESOLVED, STATION_PROP_WEBSITE,
            STATION_PROP_BUTTON1, STATION_PROP_BUTTON2
    };
    public static int MAX_ELEM = 27;
}
